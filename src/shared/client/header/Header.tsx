...
export default function Header() {
    ...
    return (
        <header className="fixed top-0 left-0 right-0 z-50 w-full border-b border-gray-200 bg-white px-4 py-2 sm:px-8">
                ...
                <nav className="flex items-center justify-between">
                    ...
                    <div className="hidden lg:block items-center space-y-2">
                        <div className="flex gap-4">
                            <Link to="/" className="text-black-primary hover:text-gray-900">
                                Inicio
                            </Link>
                            <div className="relative group">
                                <Link
                                    to="/categories"
                                    className="flex items-center text-black-primary hover:text-gray-900">
                                    Categorías
                                    <Icon
                    ...
                    <div className="hidden lg:flex space-x-4">
                        <Link
                            to="/login"
                            className="px-4 py-2 rounded-md border font-medium text-primary border-primary hover:border-primary-dark hover:text-purple-700 transition">
                            Iniciar sesión
                        </Link>
                        <Link
                            to="/register"
            ...
            {/* Mobile Menu Overlay */}
            {menuAbierto && (
                <div className="lg:hidden fixed inset-0 z-50 bg-black/50" onClick={toggleMenu}></div>
            )}
